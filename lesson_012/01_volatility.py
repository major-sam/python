...
TickerClass().run()
# Возможно ли вместо словаря использовать объекты класса? у меня получилось только создавать объекты и складвать
# ссылки на них в список. При попытки вытащить их - начинался бардак.
# оставил на словаре - гдето на stackoverflow мерили время между заполнением словаря и созданием объектов
